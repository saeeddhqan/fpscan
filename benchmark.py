...
def benchmark_forward(fn, *inputs, repeats = 10, desc='', verbose=True, **kwinputs):
	...
	t = benchmark.Timer(
			...
			globals={'fn_amp': fn, 'inputs': inputs, 'kwinputs': kwinputs},
...
def benchmark_all(fn, *inputs, grad=None, repeats=10, desc='', verbose=True, **kwinputs):
	...
	return (
		...
		benchmark_backward(fn, *inputs, grad=grad, repeats=repeats, desc=desc, verbose=verbose, **kwinputs),
		benchmark_combined(fn, *inputs, grad=grad, repeats=repeats, desc=desc, verbose=verbose, **kwinputs),
	)


def pytorch_profiler(fn, *inputs, trace_filename=None, backward=False, cpu=False, verbose=True, **kwinputs):
